...
void show_install_update_menu()
{
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            ...
            case ITEM_CHOOSE_INT:
                show_choose_int_zip_menu();
                break;
...
void show_partition_menu()
{
    ...
    for (;;)
    {
        ...
        options[mountable_volumes+formatable_volumes] = "mount internal SD";
        options[mountable_volumes+formatable_volumes + 1] = "mount external SD";
